...
audio-layer | next-15 + ai-sdk-v6 + supabase + langfuse + playwright | spec: .ai-dev-kit/spec.md
...
AGENTS.md can contain project-specific instructions above or below this starter-managed contract.
