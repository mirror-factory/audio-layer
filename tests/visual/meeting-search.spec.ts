/**
 * Auto-scaffolded by sync-registries.ts for meeting-search.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/meeting-search.spec.ts
 *
...
test.describe('visual: meeting-search', () => {
  test('matches baseline', async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering meeting-search.
    await page.goto('/');
    await expect(page).toHaveScreenshot(
      `meeting-search-${testInfo.project.name}.png`,
