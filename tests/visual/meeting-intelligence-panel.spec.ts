/**
 * Auto-scaffolded by sync-registries.ts for meeting-intelligence-panel.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/meeting-intelligence-panel.spec.ts
 *
...
test.describe('visual: meeting-intelligence-panel', () => {
  test('matches baseline', async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering meeting-intelligence-panel.
    await page.goto('/');
    await expect(page).toHaveScreenshot(
      `meeting-intelligence-panel-${testInfo.project.name}.png`,
