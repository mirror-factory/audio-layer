/**
 * Auto-scaffolded by sync-registries.ts for mobile-primary-nav.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/mobile-primary-nav.spec.ts
 *
...
test.describe('visual: mobile-primary-nav', () => {
  test('matches baseline', async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering mobile-primary-nav.
    await page.goto('/');
    await expect(page).toHaveScreenshot(
      `mobile-primary-nav-${testInfo.project.name}.png`,
