/**
 * Auto-scaffolded by sync-registries.ts for meeting-notes-push-panel.
 *
 ...
 *
 *   VISUAL_UPDATE=1 pnpm exec playwright test tests/visual/meeting-notes-push-panel.spec.ts
 *
...
test.describe('visual: meeting-notes-push-panel', () => {
  test('matches baseline', async ({ page }, testInfo) => {
    // TODO: point at a Storybook URL / dedicated test page rendering meeting-notes-push-panel.
    await page.goto('/');
    await expect(page).toHaveScreenshot(
      `meeting-notes-push-panel-${testInfo.project.name}.png`,
