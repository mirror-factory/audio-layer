#!/usr/bin/env tsx
/**
 * Research cache bootstrap -- creates .claude/research/ directory layout.
 *
...
const RESEARCH_DIR = join(ROOT, '.claude', 'research');
...
function bootstrap(): void {
  ...
  for (const lib of LIBRARIES) {
    ...
    entries.push({
      ...
      path: `.claude/research/libraries/${lib.id}/CURRENT.md`,
